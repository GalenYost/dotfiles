...
static const char *musiccmd[]   = { "st", "-e", "termusic", NULL };
...
static const char *audioLower[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-10%", NULL };
static const char *audioRaise[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+10%", NULL };
